...
// Alert
export const ErrorIcon = <Iconify icon="carbon:warning" width={24} />;
export const InfoIcon = <Iconify icon="carbon:information" width={24} />;
export const SuccessIcon = <Iconify icon="carbon:checkmark-outline" width={24} />;
export const WarningIcon = <Iconify icon="carbon:warning-alt" width={24} />;
