...
export const pageLinks = [
    {
        ...
        items: [
            ...
            { title: 'Index Posts', path: paths.marketing.posts },
            { title: 'Index Post', path: paths.marketing.post },
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Index Posts', path: paths.travel.posts },
            { title: 'Index Post', path: paths.travel.post },
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Index Posts', path: paths.career.posts },
            { title: 'Index Post', path: paths.career.post },
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Index Posts', path: paths.eLearning.posts },
            { title: 'Index Post', path: paths.eLearning.post },
